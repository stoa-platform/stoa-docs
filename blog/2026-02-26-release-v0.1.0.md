...
draft: true
description: "STOA v0.1.0 is the first public release of the open-source API gateway for AI agents. Includes MCP gateway, multi-tenant control plane, developer portal, and Keycloak SSO."
keywords:
  - STOA release
  - STOA v0.1.0
